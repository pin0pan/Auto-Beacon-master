...
public class BeaconListAdapter extends ArrayAdapter<Beacon> implements IDialogListener {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (beacon != null && holder != null) {
			if(!beacon.getIsRemembered()) {	// Found by scanning, 스캐닝하여 비콘을 발견한 경우
				holder.mItemContainer.setBackgroundColor(mContext.getResources().getColor(R.color.orange8));
			} else { 	// Remembered beacon, 기억되어있는 비콘을 발견한 경우
