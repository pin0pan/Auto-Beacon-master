...
public class Macro {
	...
	public static final int MACRO_WORKS_LAST = 17;

	public static final int MACRO_WORKS_NOTI_RED = 13;		//한솔 테스트용
	public static final int MACRO_WORKS_NOTI_GREEN = 14;
	public static final int MACRO_WORKS_NOTI_CHANGE = 15;
	public static final int MACRO_WORKS_NOTI_WARNING = 16;
